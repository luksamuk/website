...
Some games  are on  ~.CHD~ format.  They can be  played on  an emulator  such as
DuckStation or ~pcsx-redux~.

- *Sonic The Hedgehog XA (~engine-psx~)* [2024-09-29]\\
  A 2D Sonic The Hedgehog fangame built with PSn00bSDK.\\
  ([[https://luksamuk.codes/static/psx/?game=engine][play online]] /  [[https://luksamuk.codes/static/psx/ENGINEPSX.CHD][latest build]]  / [[https://github.com/luksamuk/engine-psx][source code]])
