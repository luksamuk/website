...
- [[file:files/believe-literate.pdf][Believe: A Bel interpreter built in C]] (PDF; Unfinished)\\
  A  literate program  containing  a  described implementation  of  Bel, a  Lisp
  dialect proposed by Paul Graham.\\
  [[github.com/luksamuk/believe][See also the archived repository on GitHub.]]\\
  [2021-04-18]
