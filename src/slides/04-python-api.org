...
#+HTML_HEAD_EXTRA: <style>.reveal .slides > section { background-image: url('./slide_04.gif'); background-size: cover; }</style>

* 📰 Fofocas da Semana

#+ATTR_HTML: :style font-size:0.6em;text-align:left;
- *Nova aula, novas fofocas* → atualizar na hora da aula!
