...
- *Claude Fable 5 / Mythos 5 banidos* (12/06) — Gov. dos EUA emite diretiva de *controle de exportação* citando segurança nacional. Anthropic forçada a desativar ambos globalmente — nem clientes pagantes usam. Amazon (AWS) levou ao白宫 após jailbreak de 3 palavras. Restrição se aplica a *qualquer estrangeiro*, incluindo funcionários da própria Anthropic. Opus 4.8 = fallback, mas com mais falsos positivos 🔒⚠️
...
#+ATTR_HTML: :style font-size:0.55em;
- *GPT-5.6 restrito* (25/06) — Trump admin pede à OpenAI para limitar rollout a *parceiros aprovados pelo governo*, "cliente por cliente" durante preview. GPT-5.6 visto como "equivalente ao Mythos" em cybersecurity. *Primeira vez* que EUA bloqueia release de frontier AI *antes* do lançamento público. Altman em memo interno: "não é nosso modelo preferido a longo prazo" 🔒⚠️
  - Veio *duas semanas* depois do ban da Anthropic — agora OpenAI também está sob controle federal
