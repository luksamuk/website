...
** Demo prática de agentes (18/09)

Agentes de código rodando ao vivo, local-first:

- *OpenCode* — agente de código open source no terminal
- *Pi* — coding agent minimalista
- *Hermes Agent* — assistente com memória, skills e automação
- *Sprachspiel* — harness cognitivo local (tools + OCR)
- *Claude Code* — contraste com um agente cloud
