...
# Semana 2 - 11/09/2026
#+DESCRIPTION: Semana 2 - Guilda de IA: Aprendendo Prompt Engineering
...
Mas há muito mais por trás de "perguntar melhor". Nesta aula vamos explorar a ciência e a arte do Prompt Engineering, com fundamentação teórica e técnicas avançadas validadas por pesquisa.
...
| Gemma 4 E2B (QAT) | Ollama local | Leve, roda em notebook |
...
💡 Isso vai ser fundamental nas aulas de Ferramentas e Agentes.

* Sprachspiel: Seu assistente no terminal

O [[https://github.com/luksamuk/sprachspiel][Sprachspiel]] é um CLI que conversa com modelos locais via Ollama:
...
# Pergunta direta
sprach "Traduza para inglês: Bom dia"

# Tradução e OCR (especialidades do Sprachspiel)
sprach translate en:pt "Hello world"
sprach ocr documento.png
#+END_SRC

Os modos especializados (chat, translate, OCR, summarize) são *role prompting aplicado* — mudam o comportamento do modelo sem que você precise digitar o role manualmente.
