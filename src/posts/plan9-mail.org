...
Over the past weekend  -- and over this week too -- there  is a Plan 9
bootcamp taking  place at SDF.org.  People were welcome  to subscribe,
and I was  one of the lucky  ones who got in. We  were given temporary
VPS access so that we can try Plan 9 and connect remotely to it.

SDF is a service that has been  online for (most of) 35 years now, and
offers free Unix shell access to anyone willing to go the distance and
learn the basics of  Unix. All they ask for is an  initial, fee of US$
1, which validates your account forever  (though it will not grant you
extra capabilities which proper signatures give you).

SDF ends  up being a  community of hackers, in  the best sense  of the
world.  Those are  people  passionate about  technology  and that  are
willing to  learn new stuff  -- while  also leveraging the  old stuff,
from the golden days of computation.

SDF has  been the home  of this blog until  last year, when  I finally
switched to  a new  place. But SDF  has always been  on my  heart and,
though  I did  not  interact  enough on  mailing  lists,  ~com~, or  its
Mastodon instance. But I've taken the opportunity to come back at full
force, and  to learn new stuff  about Plan 9  so I can improve  my own
Plan 9 box I got at home.
...
This could  also be  done by  console and  using ~ed~,  though I  do not
recommend it; Plan  9 is supposed to be graphical  before anything. It
is  much more  enjoyable to  use a  graphical terminal  and a  3-mouse
button.

** Achtung!

Before  anything, here  are some  links which  I used  to compile  the
informations to come. You may find it useful to take a look at them.
...
- [[https://www.youtube.com/watch?v=byoznMe8ab4][YouTube:  Acme Mail  Demo]].  This  shows details  on  using Acme  for
  e-mail. You may want to see it at the end.
