...
#+BIND: theme-selector-thing "<script src=\"../js/theme-selector.js\"></script><div id=\"theme-selector\"><center><img onclick=\"javascript:switchTheme('light')\" src=\"../img/theme-white.png\"/><img onclick=\"javascript:switchTheme('dark')\" src=\"../img/theme-black.png\"/></center></div>"

#+BIND: org-html-preamble-format (("en" "<h1 class=\"title\">%t</h1>" "<p><i>Written in %d by %a<br/>%e</i></p>") ("pt_BR" "<h1 class=\"title\">%t</h1><p><i>Escrito em %d por %a<br/>%e</i></p>" theme-selector-thing))
...
(setq theme-selector-thing
      (concat "<script src=\"../js/theme-selector.js\"></script>"
	      "<div id=\"theme-selector\">"
	      "<center>"
	      "<img onclick=\"javascript:switchTheme('light')\" src=\"../img/theme-white.png\"/>"
	      "<img onclick=\"javascript:switchTheme('dark')\" src=\"../img/theme-black.png\"/>"
	      "</center>"
	      "</div>"))
